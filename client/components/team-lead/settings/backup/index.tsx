...
export default function BackupSettings() {
  ...
  const [showConfirm, setShowConfirm] = useState<"progress" | "files" | null>(
    null
  );
  ...
  return (
    <>
      <Frame id="backup-settings" stackedPanels>
        <FrameHeader>
          <FrameTitle>Data Backup & Export</FrameTitle>
          <FrameDescription>
            Download backups of your project progress and files. This includes
            all metadata, tasks, deliverables, evidence, and meeting minutes.
          </FrameDescription>
        </FrameHeader>
        <FramePanel className="space-y-6">
          ...
          <p className="mb-4 text-muted-foreground text-sm">
            Download a JSON file containing all project metadata, phases,
            deliverables, sprints, tasks, and their current status.
          </p>
          <Button
        ...
        <FramePanel>
          ...
          <p className="mb-4 text-muted-foreground text-sm">
            Download a ZIP archive containing all uploaded evidence files and
        ...
        <FrameFooter>
          ...
          <p className="text-muted-foreground text-sm">
            <strong>Note:</strong> These exports include all project data and
            files. Store them securely for archival purposes.
          </p>
        </FrameFooter>
      </Frame>
