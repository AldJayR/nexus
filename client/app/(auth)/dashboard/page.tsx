            ...
            <CardContent className="p-0">
              <div className="flex flex-col">
                {activitiesData.map((activity, index) => {
                  ...
                  return (
                    <div
                      className={`flex gap-4 p-4 transition-colors hover:bg-muted/50 ${index < activitiesData.length - 1 ? "border-border border-b" : ""}`}
                      key={activity.id}
                    >
                      <div
                      ...
                      <div className="flex flex-1 flex-col gap-1">
                        ...
                        <p
                          className={`text-xs ${activity.statusType === "destructive" ? "font-medium text-destructive" : "text-muted-foreground"}`}
                        >
                          {activity.status}
                        </p>
                      </div>
